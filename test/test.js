...
describe('basic vector operations → ', function(){
    ...
    it('should divide each element with the scalar', function(){
        expect(m(m([1,4,7,9,16]).disperse(12))).to
